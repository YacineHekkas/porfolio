...
>
  ...
  />
      ...
      >
        ...
        <span >transforming your <span className="font-bold">ideas</span> into <span className="font-bold">reality</span> that's <span className="font-bold">my job</span> </span>.
      </motion.h1>
...
>
  ...
  <span className="font-semibold">contact me</span>.
      ...
      <motion.div
        className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
